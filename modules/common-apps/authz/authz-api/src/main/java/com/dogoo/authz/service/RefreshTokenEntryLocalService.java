...
/**
 * Provides the local service interface for RefreshTokenEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RefreshTokenEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RefreshTokenEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.authz.service.impl.RefreshTokenEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the refresh token entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RefreshTokenEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RefreshTokenEntry addRefreshTokenEntry(
		String userName, String token, Date expiryDate);
