...
public class NotFoundException extends Exception{
    ...
    public NotFoundException(Integer status, String code, String message) {
        this.status = status;
        this.code = code;
        this.normalMessage = message;
    }

    public NotFoundException(Integer status, String code, String message, String developerMessage) {
