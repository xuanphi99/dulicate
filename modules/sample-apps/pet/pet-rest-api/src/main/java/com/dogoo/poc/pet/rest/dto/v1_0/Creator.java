package com.dogoo.poc.pet.rest.dto.v1_0;
...
public class Creator implements Serializable {
	...
	@Schema(description = "The author's email.")
	...
	@GraphQLField(description = "The author's email.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(description = "The list roles of creator")
	...
	@GraphQLField(description = "The list roles of creator")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected String roles;

	@Schema(description = "The list orgIds that user belong to")
	...
	@GraphQLField(description = "The list orgIds that user belong to")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(
		...
		defaultValue = "com.dogoo.poc.pet.rest.dto.v1_0.Creator",
		name = "x-class-name"
	)
