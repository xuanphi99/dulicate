package com.dogoo.employee.rest.client.resource.v1_0;
...
public interface EmployeeResource {
	...
	public HttpInvoker.HttpResponse addEmployeeHttpResponse(Employee employee)
		throws Exception;
	...
	public static class EmployeeResourceImpl implements EmployeeResource {
		...
		public HttpInvoker.HttpResponse deleteEmployeeHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/employee-rest-builder/v1.0/employees/{employeeId}");
		...
		public HttpInvoker.HttpResponse deleteEmployeeBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/employee-rest-builder/v1.0/employees/batch");
		...
		public HttpInvoker.HttpResponse getEmployeesHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/dogoo/employee-rest-builder/v1.0/employees");
		...
		public Employee addEmployee(Employee employee) throws Exception {
			HttpInvoker.HttpResponse httpResponse = addEmployeeHttpResponse(
				employee);
		...
		public HttpInvoker.HttpResponse addEmployeeHttpResponse(
				Employee employee)
			throws Exception {
