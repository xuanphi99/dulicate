package com.dogoo.employee.rest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	public Employee addEmployee(@GraphQLName("employee") Employee employee)
		throws Exception {

		return _applyComponentServiceObjects(
			_employeeResourceComponentServiceObjects,
			this::_populateResourceContext,
			employeeResource -> employeeResource.addEmployee(employee));
	}
